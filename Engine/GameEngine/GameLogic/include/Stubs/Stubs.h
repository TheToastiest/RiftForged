...
#include "../GameEngine/ActivePlayer.h" // For GameLogic::ActivePlayer and likely GameLogic::EquippedWeaponCategory
#include "../FlatBuffers/Versioning/V0.0.5/riftforged_common_types_generated.h" // For Networking::Shared::DamageInstance and Networking::Shared::DamageType
#include "../FlatBuffers/Versioning/V0.0.5/riftforged_item_definitions_generated.h"
