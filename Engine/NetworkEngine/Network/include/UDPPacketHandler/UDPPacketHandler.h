...
#include "../FlatBuffers/Versioning/V0.0.5/riftforged_c2s_udp_messages_generated.h" // For C2S_UDP_Payload
#include "../FlatBuffers/Versioning/V0.0.5/riftforged_s2c_udp_messages_generated.h" // For S2C_UDP_Payload
