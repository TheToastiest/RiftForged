...
enum DamageType : int8_t {
  ...
  DamageType_Radiant = 2,
  DamageType_Frost = 3,
  DamageType_Lightning = 4,
  DamageType_Necrotic = 5,
  DamageType_Void = 6,
  DamageType_Cosmic = 7,
  DamageType_Poison = 8,
  DamageType_Nature = 9,
  DamageType_Aetherial = 10,
  DamageType_MIN = DamageType_None,
...
inline const char *EnumNameDamageType(DamageType e) {
  if (::flatbuffers::IsOutRange(e, DamageType_None, DamageType_Aetherial)) return "";
...
enum AnimationState : uint32_t {
  ...
  AnimationState_Walking = 1,
  AnimationState_Running = 2,
...
enum StunSeverity : int8_t {
  StunSeverity_None = 0,
  StunSeverity_Light = 1,
  StunSeverity_Medium = 2,
  StunSeverity_Heavy = 3,
  StunSeverity_Root = 4,
  StunSeverity_MIN = StunSeverity_None,
  StunSeverity_MAX = StunSeverity_Root
};

inline const StunSeverity (&EnumValuesStunSeverity())[5] {
...
inline const char *EnumNameStunSeverity(StunSeverity e) {
  if (::flatbuffers::IsOutRange(e, StunSeverity_None, StunSeverity_Root)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum StatusEffectCategory : uint32_t {
  ...
  StatusEffectCategory_DoT_Lightning = 53,
...
inline const StatusEffectCategory (&EnumValuesStatusEffectCategory())[58] {
  static const StatusEffectCategory values[] = {
    ...
    StatusEffectCategory_DoT_Lightning,
...
inline const char *EnumNameStatusEffectCategory(StatusEffectCategory e) {
  switch (e) {
    ...
    case StatusEffectCategory_DoT_Lightning: return "DoT_Lightning";
